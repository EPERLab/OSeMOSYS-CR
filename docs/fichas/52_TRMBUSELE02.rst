...
.. figure:: img/TRMBUSELE02_TotalAnnualMaxCapacity_BAU.png
   ...
   *Figure 2) Total Annual Max Capacity for TRMBUSELE02 for BAU scenario.*
   
The figure 3 shows the Total Annual Max Capacity for TRMBUSELE02, for the NDP and OP15C scenarios.

.. figure:: img/TRMBUSELE02_TotalAnnualMaxCapacity_NDP_OP.png
   :align:   center
   :width:   700 px
   
   *Figure 3) Total Annual Max Capacity for TRMBUSELE02 for NDP and OP15C scenarios.*
...
+++++++++
The figure 4 shows the Total Technology Annual Activity Lower Limit for TRMBUSELE02, for the NDP and OP15C scenarios.

.. figure:: img/TRMBUSELE02_TotalTechnologyAnnualActivityLowerLimit_NDP_OP.png
   :align:   center
   :width:   700 px
   
   *Figure 4) Total Technology Annual Activity Lower Limit for TRMBUSELE02 for NDP and OP15C scenarios.*
