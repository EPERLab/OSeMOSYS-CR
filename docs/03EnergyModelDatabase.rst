...
.. figure::  img/CapacityFactor_PNE.png
   :align:   center
   :width:   700 px
    
   *Figure 3.4: Capacity factor for plants* :download:`. <doc_imgs/CapacityFactor_PNE.csv>`  
...
.. figure::  img/Installed_Capacity_PNE.png
   :align:   center
   :width:   700 px
   
   *Figure 3.5: Installed capacity in the Costa Rican power system (based on CENCE)* :download:`. <doc_imgs/ResidualCapacity_PNE.csv>` 
...
.. figure::  img/ResiduaL_Capacity_Transport_PNE.png
   ...
   *Figure 3.6: Residual capacities for (a) public, (b) private and (c) cargo transport* :download:`. <doc_imgs/ResidualCapacityTransport_PNE.csv>` 
